  ...
  data () {
    return {
      ...
      headers: [
        ...
        {text: 'UP Mail', value: 'up_mail', sortable: true},
  ...
  <div class="adminMainDiv align-items-center d-flex flex-column justify-content-center" style="background-color: lightgray; gap: 20px; padding: 30px;">
    ...
    <div ref="usersDashboard" class="flex-column userDashboard" style="background-color: #F8F6F0; border: 2px solid black; width: 100%;">
      ...
      <div style="padding: 15px 20px;">
        ...
        <Vue3EasyDataTable @click-row="" alternating body-text-direction="center" buttons-pagination :headers="headers" header-text-direction="center" :items="users" show-index>
          <template #item-edit="item">
            <div class="align-items-center d-flex flex-row hoverTransform justify-content-center m-auto" style="background-color: #751518; border-radius: 5px; color: white; cursor: pointer; padding: 3px 0px; width: 70px;">

        ...
        <table class="fixed-table-body searchable sortable table table-responsive">
          <thead>
            <tr>
              ...
              <th class="text-center" scope="col">Role
                <!-- <div>
                  <span class="hoverTransform">Role</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi-sort-alpha-down" viewBox="0 0 16 16" style="margin-bottom: 2px; margin-left: 5px;">

...
<div ref="mainDiv" class="flex-column justify-content-between" style="display: none; flex: 1;">
    <Header :user="this.user" />
    <!-- Admin Div -->
    <div id="adminDiv" class="align-items-center d-flex flex-column justify-content-center">
        <!-- Menu Div -->
        <div ref="menuDiv" class="align-items-center flex-column" style="display: flex; gap: 20px;">
            <div class="d-flex hoverTransform">
                <span @click="hideDiv('menuDiv'); showDiv('usersDashboard');" class="myButton2" style="background-color: #751518;">Users Dashboard</span>
            </div>
        </div>
        <!-- end Menu Div -->
        <!-- Batch Upload Div -->
        <div ref="batchUploadDiv" class="flex-column users-dashboard-div">
            <!-- Batch Upload Header -->
            <div class="align-items-center d-flex justify-content-between users-dashboard-div-header">
        ...
        <!-- Delete User Div -->
        <div ref="deleteUserDiv" class="flex-column users-dashboard-div">
            <!-- Delete User Header -->
            <div class="align-items-center d-flex justify-content-between users-dashboard-div-header">
        ...
        <!-- end Delete User Div -->
        <!-- Edit User Div -->
        <div ref="editUserDiv" class="flex-column users-dashboard-div">
            <!-- Edit User Header -->
            <div class="align-items-center d-flex justify-content-between users-dashboard-div-header">
        ...
        <!-- end Edit User Div -->
        <!-- Register User Div -->
        <div ref="registerUserDiv" class="flex-column users-dashboard-div">
        ...
        <!-- View User Div -->
        <div ref="viewUserDiv" class="flex-column users-dashboard-div">
            <!-- View User Header -->
            <div class="align-items-center d-flex justify-content-between users-dashboard-div-header">
        ...
        <!-- end View User Div -->
        <!-- Users Dashboard -->
        <div id="usersDashboard" ref="usersDashboard" class="flex-column">
